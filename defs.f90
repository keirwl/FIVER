module defs
    ...
    ! board squares
    enum, bind(c)
        enumerator :: A1=22, B1, C1, D1, E1, F1, G1, H1
        enumerator :: A2=32, B2, C2, D2, E2, F2, G2, H2
        enumerator :: A3=42, B3, C3, D3, E3, F3, G3, H3
        enumerator :: A4=52, B4, C4, D4, E4, F4, G4, H4
        enumerator :: A5=62, B5, C5, D5, E5, F5, G5, H5
        enumerator :: A6=72, B6, C6, D6, E6, F6, G6, H6
        enumerator :: A7=82, B7, C7, D7, E7, F7, G7, H7
        enumerator :: A8=92, B8, C8, D8, E8, F8, G8, H8
        enumerator NO_SQ
    endenum
